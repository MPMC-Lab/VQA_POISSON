...
class QuantumComputer(ABC):
    def __init__(
        ...
        Args:
            ...
            params_list: List of parameter vectors, one per expectation value. Each array should match the number of parameters in its corresponding ansatz circuit.
        ...
        self.params_list: List[np.ndarray] = params_list
    ...
    def transpile(self,
        ...
        for evs_idx in range (self.num_evs):
            params = self.params_list[evs_idx]
