...
class LaplacianEVProcessor1D(QuantumComputer):
    def __init__(self,
        ...
        # Dirichlet (D): num_qubits circuits
        # Neumann (N): num_qubits + 1 (last is identity term)
        # Periodic (P): 1 circuit using QFT method
    ...
    def make_circuits(self) -> List[QuantumCircuit]:
        ...
        D: Dirichlet condition (from Choi et al. (2024))
        N: Neumann condition (from Choi et al. (2024))
